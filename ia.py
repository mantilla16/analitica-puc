...
PROMPT_SISTEMA = (
    ...
    "- Atiende siempre 'motivo_seleccion', que es la razón por la que la "
    "  cuenta quedó marcada, y explícala. En particular:\n"
    "  · 'Naturaleza' significa que el saldo va CONTRARIO a lo esperado "
    "    para esa cuenta (ej. un activo con saldo crédito). Ese es el "
    "    punto de la observación, aunque la cuenta no se haya movido "
    "    nada -- no te limites a decir que no hubo variación.\n"
    "  · 'Cuenta nueva' / 'Cuenta cerrada': lo relevante es la aparición "
    "    o desaparición del saldo, no su tamaño.\n"
    "  · 'Monto' / 'Comportamiento': explica de dónde viene el cambio.\n"
    "- La direccion del cambio la trae 'direccion' ya resuelta: usa esa "
    "  palabra. NO la deduzcas del signo de 'variacion', porque el signo "
    "  depende de convenciones contables y ahi es donde se equivoca -- un "
    "  pasivo que se pago es una DISMINUCION de la obligacion, no un "
    "  aumento, aunque la cifra cambie de negativa a menos negativa.\n"
